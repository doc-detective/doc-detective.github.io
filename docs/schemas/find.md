...
typeKeys | One of<br/>-&nbsp;string<br/>-&nbsp;object |  Optional. Type keys after finding the element. Either a string or an object with a `keys` field as defined in [`typeKeys`](/docs/schemas/typeKeys).<br/><br/>To type in the element, make the element active with the `click` parameter. | 
