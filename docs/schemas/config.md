...
fileTypes.markup.actions | array of <br/>- strings<br/>- objects<br/>-&nbsp;object([checkLink](/docs/schemas/checkLink))<br/>-&nbsp;object([find](/docs/schemas/find))<br/>-&nbsp;object([goTo](/docs/schemas/goTo))<br/>-&nbsp;object([httpRequest](/docs/schemas/httpRequest))<br/>-&nbsp;object([runShell](/docs/schemas/runShell))<br/>-&nbsp;object([saveScreenshot](/docs/schemas/saveScreenshot))<br/>-&nbsp;object([setVariables](/docs/schemas/setVariables))<br/>-&nbsp;object([startRecording](/docs/schemas/startRecording))<br/>-&nbsp;object([stopRecording](/docs/schemas/stopRecording))<br/>-&nbsp;object([typeKeys](/docs/schemas/typeKeys))<br/>-&nbsp;object([wait](/docs/schemas/wait)) |  Optional. Actions that apply to the markup type. | 
