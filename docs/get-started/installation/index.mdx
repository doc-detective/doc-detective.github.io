...
- Doc Detective
- Node, Python, and Java for running and testing code
- Google Chrome and Firefox for browser-based tests
- DITA Open Toolkit (DITA-OT) for DITA content transformation

You can run Node and Python scripts, browser automation tests, and DITA transformations without installing additional dependencies on your host machine.
