...
2. Pull the Doc Detective Docker image:
    ...
    {/* step runShell: "docker pull docdetective/doc-detective" */}
...
4. Run a test, pointing to the file you just created:
    ...
    <Tabs groupId="os">
      <TabItem value="unix" label="Linux/macOS" default>
        ...
        {/* step runShell:
        command: "docker run -v $(pwd):/workspace docdetective/doc-detective --input /workspace/sample.spec.json"
        workingDirectory: "." */}
      </TabItem>
      ...
      <TabItem value="windows-cmd" label="Windows (cmd)">
        ...
        {/* step runShell:
        command: "docker run -v %cd%:/workspace docdetective/doc-detective --input /workspace/sample.spec.json"
        workingDirectory: "." */}
      </TabItem>
    </Tabs>
