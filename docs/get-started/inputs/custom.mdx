...
For simple patterns, you can use action shortcuts. Doc Detective substitutes the first capture group (or entire match) into the default location:
...
- **Use descriptive names**: Name patterns clearly to understand their purpose
