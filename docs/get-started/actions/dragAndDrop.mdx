...
- `elementText`: (Optional) Display text of the element.
...
- `elementTestId`: (Optional) The `data-testid` attribute of the element. Supports regex patterns using `/pattern/` syntax.
...
- `elementAria`: (Optional) The computed accessible name of the element per ARIA specification. Supports regex patterns using `/pattern/` syntax.
