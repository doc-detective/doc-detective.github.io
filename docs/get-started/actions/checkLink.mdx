...
- **403 Forbidden**: The server is blocking access. Common reasons:
  - Bot protection or anti-scraping measures
...
3. **For 403/401 errors on legitimate URLs**: Doc Detective automatically sends browser-like headers, but some websites still block automated tools. If you're testing internal URLs or APIs that require authentication, you can:
