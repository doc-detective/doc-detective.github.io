...
👉 See [Quick changes](/docs/contribute/docs/quick-start) for detailed instructions.
...
👉 See [Local Development Setup](/docs/contribute/docs/local-development) for detailed instructions.
...
For major documentation efforts, see [Substantial Contributions](/docs/contribute/docs/substantial-contributions).
