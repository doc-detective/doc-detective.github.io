...
For quick fixes (typos, small wording changes), use the [browser-based workflow](/docs/contribute/docs/quick-start) instead.
...
See [Standard changes](/docs/contribute/docs/standard-contributions) or [Substantial changes](/docs/contribute/docs/substantial-contributions) for PR guidelines.
...
- [Standard changes](/docs/contribute/docs/standard-contributions)
- [Substantial changes](/docs/contribute/docs/substantial-contributions)
