...
- __Found a bigger issue?__ Consider a [standard contribution](/docs/contribute/docs/standard-contributions) instead

## Ready for more?

Once you're comfortable with quick edits, try [standard contributions](/docs/contribute/docs/standard-contributions) to add new content and examples.
