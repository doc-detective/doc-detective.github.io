...
- **CLA Requirement**: Before code or documentation contributions can be merged, you need to sign the [contributor license agreement](https://cla-assistant.io/doc-detective/doc-detective.github.io). This ensures your contributions are properly licensed and maintains the project's open-source status.
...
👉 [Quick Start Guide](/docs/contributing/quick-start)
...
👉 [Standard Contributions Guide](/docs/contributing/standard-contributions)
...
For major documentation projects or new features.

👉 [Substantial Contributions Guide](/docs/contributing/substantial-contributions)
...
If your PR doesn't get a response within our SLA, feel free to ping the reviewers or post in Discord.
