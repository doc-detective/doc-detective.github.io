...
3. **Make your changes**: GitHub opens the file in a web-based editor
   - If this is your first time, GitHub will automatically fork the repository for you
4. **Preview your changes**: Use the "Preview" tab to see how it looks
5. **Commit your changes**:
   - Add a brief description of what you changed (e.g., "Fix typo in installation steps")
